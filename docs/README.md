...
| Doc | What it is |
|---|---|
| [PROJECT.md](PROJECT.md) | **Source of truth.** Architecture, scope, naming, roadmap. When PROJECT.md and other docs disagree, PROJECT.md wins. |
| [BRANCH-PROTECTION.md](BRANCH-PROTECTION.md) | Branch strategy, GitHub rulesets, merge settings, and how to recreate the protection config. |
| [CLAUDE-CODE-PROMPT.md](CLAUDE-CODE-PROMPT.md) | The Phase 1 bootstrap prompt used to scaffold this monorepo with Claude Code. Historical / archival — keep for reference. |
...
- **Cross-links:** Use relative paths. From `docs/frontend/X.md`, refer to `docs/Y.md` as `../Y.md`.
...
1. Read [PROJECT.md](PROJECT.md) in full first — that's the spec.
2. If you're touching frontend, also read [frontend/UI-STANDARDS.md](frontend/UI-STANDARDS.md).
3. If you're touching git/CI/branches, read [BRANCH-PROTECTION.md](BRANCH-PROTECTION.md) before pushing anything.
